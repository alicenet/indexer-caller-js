...
let idxCaller = new IdxCaller(
    "https://index-frontend-sg4efdgo3q-uc.a.run.app/"
);
...
export async function sampleTest() {
    ...
    let txsForAddress = await idxCaller.getTransactionsForAddress(
        testAddress,
        10,
        2
    );
    ...
    let tx = await idxCaller.getTransactionByHash(
        "0845d0afcb20888bb4eb4568d086ccce92843f57684230f22fa25c298bbe5803"
    );
    console.log(tx);
}
